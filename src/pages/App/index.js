...
const TOKEN ="pk.eyJ1IjoidHlzb25yZXplbmRlIiwiYSI6ImNrZzB0dzQyZjI5eWMyc3A5c3h4ajNiN2YifQ.GmCeGmsItYmklpyuKN3sOQ";
...
class Map extends Component {
    ...
    state={
        viewport:{
         latitude:-23.494038, //-27.200368 ,
         longitude:-46.574284, //-49.621018,
         zoom: 12.8,
         bearing: 0,
         pitch: 0  
        },
   ...
   // handleChange =e=>{
     //   this.setState({addActivate: true})
       // console.log(add)
    //}
    ...
    renderActions() {
        return (
          <ButtonContainer>
            <Button
              color="#fc6963"
              onClick={()=> this.setState({ addActivate: true},console.log(this.state.addActivate))}
            >
